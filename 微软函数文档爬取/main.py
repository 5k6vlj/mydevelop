...
if __name__ == '__main__':
    url = 'https://docs.microsoft.com/zh-cn/powerquery-m/toc.json'
    web = requests.get(url,headers=rd.choice(headers),proxies={'http':rd.choice(ip)},timeout=(5,15))
    web.encoding = web.apparent_encoding
    ...
    for i in jsonData:
        for j in i['children']:
            ...
            j['link']='https://docs.microsoft.com/zh-cn/powerquery-m/'+j['href']
            data.append(j)
